...
router.put('/:id', (0, auth_1.default)('admin'), (0, validateRequest_1.default)(car_validation_1.CarValidations.updateCarValidationSchema), car_controller_1.CarControllers.updateCars);
